...
print(f"{str_amount_fraction(milk)} {str_units(milk, UNIT_CUPS)} {TXT_MILK} {unit2ml(milk, UNIT_CUPS)}ml")
print(f"{str_amount_fraction(salt)} {str_units(salt, UNIT_TEASPOONS)} {TXT_SALT} {ml2gram(unit2ml(salt, UNIT_TEASPOONS), GRAM_PER_ML_SALT)}g")
print(f"{str_amount_fraction(pepper)} {str_units(pepper, UNIT_TEASPOONS)} {TXT_PEPPER} {ml2gram(unit2ml(pepper, UNIT_TEASPOONS), GRAM_PER_ML_PEPPER)}g")
print(f"{str_amount_fraction(oil)} {str_units(oil, UNIT_SPOONS)} {TXT_OIL} {unit2ml(oil, UNIT_SPOONS)}ml")
...
print(f"{str_amount_fraction(spinach)} {str_units(spinach, UNIT_CUPS)} {TXT_SPINACH} {ml2gram(unit2ml(spinach, UNIT_CUPS), GRAM_PER_ML_SPINACH)}g")
print(f"{str_amount_fraction(cheese)} {str_units(cheese, UNIT_CUPS)} {TXT_CHEESE} {ml2gram(unit2ml(cheese, UNIT_CUPS), GRAM_PER_ML_CHEESE)}g")
print('-----------------------------------------------')